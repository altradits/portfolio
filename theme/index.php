...
<main id="primary" class="site-main flex-1 w-full">
    ...
    <section id="hero" class="relative min-h-[95vh] sm:min-h-screen w-full bg-[#FAFAFA] flex flex-col items-center justify-center px-4 sm:px-8 lg:px-12 overflow-hidden select-none py-20 sm:py-24">
        ...
        <div id="hero-tilt-card" class="relative z-10 w-full max-w-4xl mx-auto text-center flex flex-col items-center justify-center transition-transform duration-200 ease-out will-change-transform">
            ...
            <h1 class="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight text-zinc-950 mb-6 leading-tight drop-shadow-sm flex flex-col items-center">
                <span class="block text-zinc-950">I Build Software That</span>
                <span class="relative inline-block mt-1 sm:mt-2 h-[1.3em] overflow-hidden min-w-[280px] sm:min-w-[580px] text-center">
                    <span id="hero-animated-painpoint" class="inline-block text-[#E55252] transition-all duration-500 transform translate-y-0 opacity-100">
            ...
            <p class="text-lg sm:text-xl text-zinc-600 max-w-2xl mx-auto mb-8 leading-relaxed font-normal">
